...
![Zero-length closepath behavior](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/zero_length_closepath_probe.svg)
...
![Single offset with no final trimming, cusp trimming, and in-band trimming](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/single_offset_final_trimming.svg)
...
![Single offset of concentric rectangles with offside trimming disabled and enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/single_offset_offside_trimming.svg)
...
![Band trimming with both, one, and neither side-local cusp pass enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/band_cusp_trimming.svg)

The figure-eight below holds both cusp switches at `true` and changes only the
final joint pass:

![Figure-eight band with in-band trimming disabled and enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/band_in_band_trimming.svg)
...
![Two overlapping square subpaths and their arrangement graph](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/arrangement_graph_overlapping_squares.svg)
...
![Oppositely directed equal circles with phase-shifted arc subdivisions and their arrangement graph](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/arrangement_graph_semantic_circle_overlap.svg)
...
![Eight-panel ArrangementGraph CSG example using the Nonzero fill rule](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/arrangement_csg_nonzero.svg)
...
![Eight-panel ArrangementGraph CSG example using the EvenOdd fill rule](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v0.3.0/figures/arrangement_csg_evenodd.svg)
