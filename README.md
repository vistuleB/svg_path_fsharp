...
![Zero-length closepath behavior](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/zero_length_closepath_probe.svg)
...
![Miter versus clipped miter](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/miter_clip_comparison.svg)

![MiterClip limits](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/miter_clip_limits.svg)
...
![Arcs self-intersecting example](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arcs_join_self_intersection.svg)

![Arcs disjoint circles](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arcs_join_comparison_2.svg)
...
![Single offset with no final trimming, cusp trimming, and in-band trimming](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/single_offset_final_trimming.svg)
...
![Single offset of concentric rectangles with offside trimming disabled and enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/single_offset_offside_trimming.svg)
...
After final trimming, boundaries are enumerated from even-odd-filled faces of
the surviving outlines. Every repeated edge occurrence is preserved, including
zero-area retraces; contour order and starting vertices may change. Walks keep
filled material on the visual right, including around holes. For outer offset
greater than inner offset, winding is one inside and zero outside. Opposite
kissing-seam occurrences and retraces cancel. Reversing offset ordering reverses
the band's orientation. This enumeration is skipped when `InBand = false`.
...
![Band trimming with both, one, and neither side-local cusp pass enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/band_cusp_trimming.svg)

The figure-eight below holds both cusp switches at `true` and changes only the
final joint pass:

![Figure-eight band with in-band trimming disabled and enabled](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/band_in_band_trimming.svg)
...
![Two overlapping square subpaths and their arrangement graph](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arrangement_graph_overlapping_squares.svg)
...
![Oppositely directed equal circles with phase-shifted arc subdivisions and their arrangement graph](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arrangement_graph_semantic_circle_overlap.svg)
...
![Eight-panel ArrangementGraph CSG example using the Nonzero fill rule](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arrangement_csg_nonzero.svg)
...
![Eight-panel ArrangementGraph CSG example using the EvenOdd fill rule](https://raw.githubusercontent.com/vistuleB/svg_path_fsharp/assets-v1.0.0/figures/arrangement_csg_evenodd.svg)
